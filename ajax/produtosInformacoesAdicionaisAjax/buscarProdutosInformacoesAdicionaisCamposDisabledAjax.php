<?php
    ...
    if (isset($tiposProdutos['ch_informacao_adicionais'])) { 
        if ($tiposProdutos['ch_informacao_adicionais'] == 'S')  {    
            echo '<input type=hidden name="ch_informacao_adicionais" id="ch_informacao_adicionais" value="S" disabled>';       
                ...
                case 6: ?>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" id="nr_codigo_cor" name="nr_codigo_cor" value="<?= (isset($informacoesAdicionais['nr_codigo_cor']) && !empty($informacoesAdicionais['nr_codigo_cor'])) ? $informacoesAdicionais['nr_codigo_cor'] : '' ?>" placeholder="Informe a Código da Cor da Linha" disabled>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Cor</label>
                            <input class="form-control" id="st_cor" name="st_cor" value="<?= (isset($informacoesAdicionais['st_cor']) && !empty($informacoesAdicionais['st_cor'])) ? $informacoesAdicionais['st_cor'] : '' ?>" placeholder="Informe a Cor da Linha" disabled>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Número da Linha</label>
                            <input type="text" class="form-control" id="nr_numero_linha" name="nr_numero_linha" value="<?= (isset($informacoesAdicionais['nr_numero_linha']) && !empty($informacoesAdicionais['nr_numero_linha'])) ? $informacoesAdicionais['nr_numero_linha'] : '' ?>" placeholder="Informe o Número da Linha" disabled />
                        </div>
                    </div>
                <?php
                break;
