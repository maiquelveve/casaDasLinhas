...
<div class="container my-5">
    ...
    <form>
        ...
        <button type='button' id="button-listarMarcas" class="btn btn-primary"><i class="fa fa-search"></i> Pesquisar</button>
        <a href="cadastrar.php"><button type='button' id="button-novoProdutos" class="btn btn-dark"><i class="fa fa-plus-circle"></i> Nova Marca</button></a>
    </form>
